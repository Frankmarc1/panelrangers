      ...
      <div className='h-80 w-80 flex justify-center items-center flex-col bg-base-100 border-2 border-cyan-50 rounded-xl shadow  p-3'>
        ...
        <form onSubmit={handleForm} autoComplete='off'>
          ...
          <div className='relative w-72'>
            ...
            <label
              htmlFor='pass'
              className='absolute text-md text-gray-500  duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white  px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-1 peer-focus:scale-75 peer-focus:-translate-y-4 left-1
							pointer-events-none
							'
            >
              Ingrese contraseña
